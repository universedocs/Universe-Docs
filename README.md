...
This project is big and serves all humanity if completed successfully! It is a WYSIWYG document editor, no code software, application store, document as a service, data repository, training tool, book library! This software will be developed considering all of humanity and not few! It is not profit only oriented (Capitalism apporach (competition, ownership, power, profit. Final objective is profit))! It is moving towards Paradism principles (cooperation, care, share, balance. Final objecive is Balance) (www.paradism.org) one step at a time, but still money required! So it will need enough time, human resources and human expertise to complete this project on time! The developer as to use the software of this project in their daily lives so that is usable and of hight quality! 

This projects can have deadlines, but make sure at later point of time it is human friendly! Keep track of those missed human friendly things and the reason for its delay! 
